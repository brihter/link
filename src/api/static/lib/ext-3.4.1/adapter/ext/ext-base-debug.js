...
;(function () {
  var idSeed = 0,
    ...
    isIE7 =
      isIE &&
      ((check(/msie 7/) && docMode != 8 && docMode != 9 && docMode != 10) ||
        docMode == 7),
    isIE8 =
      isIE &&
      ((check(/msie 8/) && docMode != 7 && docMode != 9 && docMode != 10) ||
        docMode == 8),
    isIE9 =
      isIE &&
      ((check(/msie 9/) && docMode != 7 && docMode != 8 && docMode != 10) ||
        docMode == 9),
    isIE10 =
      isIE &&
      ((check(/msie 10/) && docMode != 7 && docMode != 8 && docMode != 9) ||
        docMode == 10),
...
//      Your postprocessing here
    ...
    createNamespace: function (namespaceOrClass, isClass) {
      var cache = Ext.namespaceCache,
        namespace = isClass
          ? namespaceOrClass.substring(0, namespaceOrClass.lastIndexOf('.'))
          : namespaceOrClass,
        ns = cache[namespace],
        i,
        n,
        ...
        if (target.$isClass) {
          ...
          if (owner && owner.$isClass) {
            ...
            if (!target.constructor.$isClass) {
              target.constructor.prototype.callParent =
                Base.prototype.callParent
...
Ext.urlDecode("foo=1&bar=2&bar=3&bar=4", false); // returns {foo: "1", bar: ["2", "3", "4"]}
    ...
    isIterable: function (v) {
      ...
      return (
        (typeof v.nextNode != 'undefined' || v.item) && Ext.isNumber(v.length)
      )
    },
...
;(function () {
  ...
  Ext.lib.Ajax = (function () {
    ...
    function handleReadyState(o, callback) {
      ...
      if (cbTimeout) {
        pub.conn[tId] = conn
        pub.timeout[tId] = setTimeout(
          checkTimeout.createCallback(o, callback),
          cbTimeout
        )
      }
      poll[tId] = setInterval(
        checkResponse.createCallback(o, callback, conn, tId, poll, cbTimeout),
        pub.pollInterval
      )
    }
      ...
      request: function (method, uri, cb, data, options) {
        if (options) {
          ...
          if (xmlData || jsonData) {
            ...
            data =
              xmlData ||
              (!Ext.isPrimitive(jsonData) ? Ext.encode(jsonData) : jsonData)
          }
        }
